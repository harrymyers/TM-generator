...
if MAKE_QA_PLOTS:
    ...
    max_angle = min(max(ep_99, em_99), 500)  # Cap at 50 mrad for visibility
    ...
    plt.title('e⁺ vs e⁻ Angular Correlation (radiative production)')
    ...
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'qa_radiative_angular_correlation.png', dpi=150, bbox_inches='tight')
    plt.close()
